...
namespace Khayati.Infrastructure.Migrations
{
    ...
    [Migration("20241008015011_SeedMeasurmentSeed")]
    partial class SeedMeasurmentSeed
    {
            ...
            modelBuilder.Entity("Entities.Measurement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Chest = 100.0,
                            CustomerId = 1,
                            DateCreated = new DateTime(2024, 10, 8, 6, 20, 10, 895, DateTimeKind.Local).AddTicks(8807),
                            DateTaken = new DateTime(2024, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Height = 175.5,
                            Leg = 80.0,
                            Neck = 38.0,
                            ShoulderWidth = 45.0,
                        ...
                        new
                        {
                            ...
                            Chest = 101.0,
                            CustomerId = 2,
                            DateCreated = new DateTime(2024, 10, 8, 6, 20, 10, 895, DateTimeKind.Local).AddTicks(8821),
                            DateTaken = new DateTime(2024, 10, 2, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Height = 176.0,
                            Leg = 81.0,
                            Neck = 39.0,
                            ShoulderWidth = 46.0,
                        ...
                        new
                        {
                            ...
                            Chest = 99.0,
                            CustomerId = 3,
                            DateCreated = new DateTime(2024, 10, 8, 6, 20, 10, 895, DateTimeKind.Local).AddTicks(8822),
                            DateTaken = new DateTime(2024, 10, 3, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Height = 175.5,
                            Leg = 79.0,
                            Neck = 38.5,
                            ShoulderWidth = 45.0,
                        ...
                        new
                        {
                            ...
                            Chest = 102.0,
                            CustomerId = 4,
                            DateCreated = new DateTime(2024, 10, 8, 6, 20, 10, 895, DateTimeKind.Local).AddTicks(8824),
                            DateTaken = new DateTime(2024, 10, 4, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Height = 177.0,
                            Leg = 82.0,
                            Neck = 40.0,
                            ShoulderWidth = 46.0,
